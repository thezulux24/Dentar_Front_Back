...
export class CreatePacienteDto {
  @ApiProperty({ description: 'Correo electrónico del paciente' })
  ...
  @ApiProperty({ description: 'Contraseña del paciente' })
  ...
  @ApiPropertyOptional({ description: 'Dirección del paciente' })
  @IsOptional()
